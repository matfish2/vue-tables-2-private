...
exports.install = function (
    ...
    var client = merge.recursive(true, Table(), {
        ...
        methods: {
            applyInfiniteScroll() {
                this.currentTarget = `.VueTables__row.index-${this.lastRecord}`;
                ...
                this.$nextTick(() => {
                    let observer = new IntersectionObserver(entries => {
                        entries.forEach((e) => {
                            if (e.isIntersecting) {
                                ...
                                this.lastRecord = this.lastRecord + this.limit;
                                observer.unobserve(this.$el.querySelector(this.currentTarget));
                                this.applyInfiniteScroll();
                            }
                        })
                    }, {
                    ...
                    var el = this.$el.querySelector(this.currentTarget);
